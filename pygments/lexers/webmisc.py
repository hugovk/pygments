...
class XQueryLexer(ExtendedRegexLexer):
    ...
    ncname = "(?:{}+{}*)".format(ncnamestartchar, ncnamechar)
    pitarget_namestartchar = r"(?:[A-KN-WYZ]|_|:|[a-kn-wyz])"
    pitarget_namechar = r"(?:" + pitarget_namestartchar + r"|-|\.|[0-9])"
    pitarget = "{}+{}*".format(pitarget_namestartchar, pitarget_namechar)
    prefixedname = "{}:{}".format(ncname, ncname)
    unprefixedname = ncname
    qname = "(?:{}|{})".format(prefixedname, unprefixedname)
