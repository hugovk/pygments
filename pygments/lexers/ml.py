...
class SMLLexer(RegexLexer):
    ...
    tokens = {
        ...
        'vname': [
            ...
            (r'({})(\s*)(=(?!{}))'.format(alphanumid_re, symbolicid_re),
             bygroups(Name.Variable, Text, Punctuation), '#pop'),
            (r'({})(\s*)(=(?!{}))'.format(symbolicid_re, symbolicid_re),
             bygroups(Name.Variable, Text, Punctuation), '#pop'),
        ...
        'ename': [
            ...
            (r'(and\b)(\s*)(%s)' % symbolicid_re,
             bygroups(Keyword.Reserved, Text, Name.Class)),
            (r'\b(of)\b(?!\')', Keyword.Reserved),
            (r'({})|({})'.format(alphanumid_re, symbolicid_re), Name.Class),
...
class OcamlLexer(RegexLexer):
    ...
    tokens = {
        ...
        'root': [
            ...
            (r'({}|{})?{}'.format(infix_syms, prefix_syms, operators), Operator),
